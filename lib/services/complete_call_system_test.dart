...
// Complete Active Call Screen with NEW PROJECT
...
class _CompleteActiveCallScreenState extends State<CompleteActiveCallScreen> {
  ...
  Future<void> _initializeAgora() async {
    try {
      ...
      // 🔥 EMPTY TOKEN FOR NEW PROJECT WITHOUT CERTIFICATE
      ...
      print('🔑 Using empty token for new project without certificate');
